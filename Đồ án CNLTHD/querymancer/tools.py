...
from querymancer.custom_logging import log, log_panel
...
#     Args:
#         reasoning: python -m streamlit run querymancer/app.py explanation of why you need to see all tables (relate to the user's query)
...
#                 AND (table_name LIKE '%product%' OR table_name LIKE '%item%')
#                 """
#             )
#             tables = [row[0] for row in cursor.fetchall()]
#             return str(tables)
